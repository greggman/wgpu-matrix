 ...
 */
export function create(v0, v1, v2, v3, v4, v5, v6, v7, v8, v9, v10, v11, v12, v13, v14, v15) {
 ...
 */
export function set(v0, v1, v2, v3, v4, v5, v6, v7, v8, v9, v10, v11, v12, v13, v14, v15, dst) {
 ...
 */
export function fromMat3(m3, dst) {
    dst = dst || new MatType(16);
    dst[0] = m3[0];
    dst[1] = m3[1];
    dst[2] = m3[2];
 ...
 */
export function aim(position, target, up, dst) {
    dst = dst || new MatType(16);
 ...
 * @returns The aim matrix.
 */
export function cameraAim(eye, target, up, dst) {
    dst = dst || new MatType(16);
    xAxis = xAxis || vec3.create();
    yAxis = yAxis || vec3.create();
    zAxis = zAxis || vec3.create();
