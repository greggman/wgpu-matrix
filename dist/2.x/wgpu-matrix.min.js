...
c){c=c||new z(2);c[0]=a[0]/b[0];c[1]=a[1]/b[1];return c}function Ga(a){const b=Ha;Ha=a;H=Ia.get(a);return b}function pa(a,b){b=b||H();b[0]=a[0];b[1]=a[1];b[2]=a[2];b[4]=a[4];b[5]=a[5];b[6]=a[6];b[8]=a[8];b[9]=a[9];b[10]=a[10];return b}function Ja(a){a=a||H();a[0]=1;a[1]=0;a[2]=0;a[4]=0;a[5]=1;a[6]=0;a[8]=0;a[9]=0;a[10]=1;return a}function Ka(a,b){b=b||H();const c=a[0],d=a[1],e=a[2],f=a[4],g=a[5],h=a[6],l=a[8],k=a[9];a=a[10];const m=g*a,n=k*h,q=d*a,v=k*e,u=d*h,t=g*e,p=1/(c*(m-n)-f*(q-v)+l*(u-t));b[0]=
+(m-n)*p;b[1]=-(f*a-l*h)*p;b[2]=+(f*k-l*g)*p;b[4]=-(q-v)*p;b[5]=+(c*a-l*e)*p;b[6]=-(c*k-l*d)*p;b[8]=+(u-t)*p;b[9]=-(c*h-f*e)*p;b[10]=+(c*g-f*d)*p;return b}function La(a,b,c){c=c||H();const d=a[0],e=a[1],f=a[2],g=a[4],h=a[5],l=a[6],k=a[8],m=a[9];a=a[10];const n=b[0],q=b[1],v=b[2],u=b[4],t=b[5],p=b[6],E=b[8],F=b[9];b=b[10];c[0]=d*n+g*q+k*v;c[1]=e*n+h*q+m*v;c[2]=f*n+l*q+a*v;c[4]=d*u+g*t+k*p;c[5]=e*u+h*t+m*p;c[6]=f*u+l*t+a*p;c[8]=d*E+g*F+k*b;c[9]=e*E+h*F+m*b;c[10]=f*E+l*F+a*b;return c}function Ma(a){const b=
...
b){b=b||new w(3);b[0]=a[0];b[1]=a[1];b[2]=a[2];return b}function Ta(a,b,c){c=c||new w(3);c[0]=a[0]*b[0];c[1]=a[1]*b[1];c[2]=a[2]*b[2];return c}function Ua(a,b,c){c=c||new w(3);c[0]=a[0]/b[0];c[1]=a[1]/b[1];c[2]=a[2]/b[2];return c}function Va(a){const b=x;x=a;return b}function sa(a,b){b=b||new x(16);b[0]=a[0];b[1]=a[1];b[2]=a[2];b[3]=a[3];b[4]=a[4];b[5]=a[5];b[6]=a[6];b[7]=a[7];b[8]=a[8];b[9]=a[9];b[10]=a[10];b[11]=a[11];b[12]=a[12];b[13]=a[13];b[14]=a[14];b[15]=a[15];return b}function Wa(a){a=a||
new x(16);a[0]=1;a[1]=0;a[2]=0;a[3]=0;a[4]=0;a[5]=1;a[6]=0;a[7]=0;a[8]=0;a[9]=0;a[10]=1;a[11]=0;a[12]=0;a[13]=0;a[14]=0;a[15]=1;return a}function Xa(a,b){b=b||new x(16);const c=a[0];var d=a[1];const e=a[2],f=a[3],g=a[4];var h=a[5];const l=a[6],k=a[7],m=a[8],n=a[9],q=a[10],v=a[11],u=a[12];var t=a[13];const p=a[14];a=a[15];const E=q*a,F=p*v,I=l*a,J=p*k,L=l*v,M=q*k,Q=e*a,R=p*f,S=e*v,T=q*f,U=e*k,V=l*f,W=m*t,X=u*n,Y=g*t,Z=u*h,da=g*n,ea=m*h,fa=c*t,ha=u*d,ia=c*n,ja=m*d,ka=c*h,la=g*d,Ya=E*h+J*n+L*t-(F*h+
I*n+M*t),Za=F*d+Q*n+T*t-(E*d+R*n+S*t);t=I*d+R*h+U*t-(J*d+Q*h+V*t);d=M*d+S*h+V*n-(L*d+T*h+U*n);h=1/(c*Ya+g*Za+m*t+u*d);b[0]=h*Ya;b[1]=h*Za;b[2]=h*t;b[3]=h*d;b[4]=h*(F*g+I*m+M*u-(E*g+J*m+L*u));b[5]=h*(E*c+R*m+S*u-(F*c+Q*m+T*u));b[6]=h*(J*c+Q*g+V*u-(I*c+R*g+U*u));b[7]=h*(L*c+T*g+U*m-(M*c+S*g+V*m));b[8]=h*(W*k+Z*v+da*a-(X*k+Y*v+ea*a));b[9]=h*(X*f+fa*v+ja*a-(W*f+ha*v+ia*a));b[10]=h*(Y*f+ha*k+ka*a-(Z*f+fa*k+la*a));b[11]=h*(ea*f+ia*k+la*v-(da*f+ja*k+ka*v));b[12]=h*(Y*q+ea*p+X*l-(da*p+W*l+Z*q));b[13]=h*(ia*
p+W*e+ha*q-(fa*q+ja*p+X*e));b[14]=h*(fa*l+la*p+Z*e-(ka*p+Y*e+ha*l));b[15]=h*(ka*q+da*e+ja*l-(ia*l+la*q+ea*e));return b}function $a(a,b,c){c=c||new x(16);const d=a[0],e=a[1],f=a[2],g=a[3],h=a[4],l=a[5],k=a[6],m=a[7],n=a[8],q=a[9],v=a[10],u=a[11],t=a[12],p=a[13],E=a[14];a=a[15];const F=b[0],I=b[1],J=b[2],L=b[3],M=b[4],Q=b[5],R=b[6],S=b[7],T=b[8],U=b[9],V=b[10],W=b[11],X=b[12],Y=b[13],Z=b[14];b=b[15];c[0]=d*F+h*I+n*J+t*L;c[1]=e*F+l*I+q*J+p*L;c[2]=f*F+k*I+v*J+E*L;c[3]=g*F+m*I+u*J+a*L;c[4]=d*M+h*Q+n*R+
t*S;c[5]=e*M+l*Q+q*R+p*S;c[6]=f*M+k*Q+v*R+E*S;c[7]=g*M+m*Q+u*R+a*S;c[8]=d*T+h*U+n*V+t*W;c[9]=e*T+l*U+q*V+p*W;c[10]=f*T+k*U+v*V+E*W;c[11]=g*T+m*U+u*V+a*W;c[12]=d*X+h*Y+n*Z+t*b;c[13]=e*X+l*Y+q*Z+p*b;c[14]=f*X+k*Y+v*Z+E*b;c[15]=g*X+m*Y+u*Z+a*b;return c}function ab(a,b,c){c=c||new x(16);let d=a[0],e=a[1];a=a[2];var f=Math.sqrt(d*d+e*e+a*a);d/=f;e/=f;a/=f;f=d*d;const g=e*e,h=a*a,l=Math.cos(b);b=Math.sin(b);const k=1-l;c[0]=f+(1-f)*l;c[1]=d*e*k+a*b;c[2]=d*a*k-e*b;c[3]=0;c[4]=d*e*k-a*b;c[5]=g+(1-g)*l;c[6]=
e*a*k+d*b;c[7]=0;c[8]=d*a*k+e*b;c[9]=e*a*k-d*b;c[10]=h+(1-h)*l;c[11]=0;c[12]=0;c[13]=0;c[14]=0;c[15]=1;return c}function bb(a,b,c,d){d=d||new x(16);var e=b[0],f=b[1],g=b[2];b=Math.sqrt(e*e+f*f+g*g);e/=b;f/=b;g/=b;b=e*e;var h=f*f,l=g*g,k=Math.cos(c),m=Math.sin(c),n=1-k;c=b+(1-b)*k;b=e*f*n+g*m;const q=e*g*n-f*m,v=e*f*n-g*m;h+=(1-h)*k;const u=f*g*n+e*m,t=e*g*n+f*m;e=f*g*n-e*m;f=l+(1-l)*k;g=a[0];l=a[1];k=a[2];m=a[3];n=a[4];const p=a[5],E=a[6],F=a[7],I=a[8],J=a[9],L=a[10],M=a[11];d[0]=c*g+b*n+q*I;d[1]=
c*l+b*p+q*J;d[2]=c*k+b*E+q*L;d[3]=c*m+b*F+q*M;d[4]=v*g+h*n+u*I;d[5]=v*l+h*p+u*J;d[6]=v*k+h*E+u*L;d[7]=v*m+h*F+u*M;d[8]=t*g+e*n+f*I;d[9]=t*l+e*p+f*J;d[10]=t*k+e*E+f*L;d[11]=t*m+e*F+f*M;a!==d&&(d[12]=a[12],d[13]=a[13],d[14]=a[14],d[15]=a[15]);return d}function cb(a){const b=B;B=a;return b}function db(a,b,c,d){const e=new B(4);void 0!==a&&(e[0]=a,void 0!==b&&(e[1]=b,void 0!==c&&(e[2]=c,void 0!==d&&(e[3]=d))));return e}function eb(a,b,c){c=c||new B(4);b*=.5;const d=Math.sin(b);c[0]=d*a[0];c[1]=d*a[1];
c[2]=d*a[2];c[3]=Math.cos(b);return c}function fb(a,b,c){c=c||new B(4);const d=a[0],e=a[1],f=a[2];a=a[3];const g=b[0],h=b[1],l=b[2];b=b[3];c[0]=d*b+a*g+e*l-f*h;c[1]=e*b+a*h+f*g-d*l;c[2]=f*b+a*l+d*h-e*g;c[3]=a*b-d*g-e*h-f*l;return c}function ma(a,b,c,d){d=d||new B(4);const e=a[0],f=a[1],g=a[2];a=a[3];let h=b[0],l=b[1],k=b[2];b=b[3];var m=e*h+f*l+g*k+a*b;0>m&&(m=-m,h=-h,l=-l,k=-k,b=-b);if(1-m>r){const n=Math.acos(m),q=Math.sin(n);m=Math.sin((1-c)*n)/q;c=Math.sin(c*n)/q}else m=1-c;d[0]=m*e+c*h;d[1]=
...
a;return b},round:function(a,b){b=b||new z(2);b[0]=Math.round(a[0]);b[1]=Math.round(a[1]);return b},scale:wa,set:function(a,b,c){c=c||new z(2);c[0]=a;c[1]=b;return c},setDefaultType:aa,sub:va,subtract:va,transformMat3:function(a,b,c){c=c||new z(2);const d=a[0];a=a[1];c[0]=b[0]*d+b[4]*a+b[8];c[1]=b[1]*d+b[5]*a+b[9];return c},transformMat4:function(a,b,c){c=c||new z(2);const d=a[0];a=a[1];c[0]=d*b[0]+a*b[4]+b[12];c[1]=d*b[1]+a*b[5]+b[13];return c},zero:function(a){a=a||new z(2);a[0]=0;a[1]=0;return a}});
let Ha=Float32Array;const Ia=new Map([[Float32Array,()=>new Float32Array(12)],[Float64Array,()=>new Float64Array(12)],[Array,()=>Array(12).fill(0)]]);let H=Ia.get(Float32Array);var Cb=Object.freeze({__proto__:null,clone:pa,copy:pa,create:function(a,b,c,d,e,f,g,h,l){const k=H();k[3]=0;k[7]=0;k[11]=0;void 0!==a&&(k[0]=a,void 0!==b&&(k[1]=b,void 0!==c&&(k[2]=c,void 0!==d&&(k[4]=d,void 0!==e&&(k[5]=e,void 0!==f&&(k[6]=f,void 0!==g&&(k[8]=g,void 0!==h&&(k[9]=h,void 0!==l&&(k[10]=l)))))))));return k},determinant:function(a){const b=
a[1],c=a[2],d=a[5],e=a[6],f=a[9],g=a[10];return a[0]*(d*g-f*e)-a[4]*(b*g-f*c)+a[8]*(b*e-d*c)},equals:function(a,b){return a[0]===b[0]&&a[1]===b[1]&&a[2]===b[2]&&a[4]===b[4]&&a[5]===b[5]&&a[6]===b[6]&&a[8]===b[8]&&a[9]===b[9]&&a[10]===b[10]},equalsApproximately:function(a,b){return Math.abs(a[0]-b[0])<r&&Math.abs(a[1]-b[1])<r&&Math.abs(a[2]-b[2])<r&&Math.abs(a[4]-b[4])<r&&Math.abs(a[5]-b[5])<r&&Math.abs(a[6]-b[6])<r&&Math.abs(a[8]-b[8])<r&&Math.abs(a[9]-b[9])<r&&Math.abs(a[10]-b[10])<r},fromMat4:function(a,
b){b=b||H();b[0]=a[0];b[1]=a[1];b[2]=a[2];b[3]=0;b[4]=a[4];b[5]=a[5];b[6]=a[6];b[7]=0;b[8]=a[8];b[9]=a[9];b[10]=a[10];b[11]=0;return b},fromQuat:function(a,b){b=b||H();var c=a[0],d=a[1],e=a[2];a=a[3];var f=c+c,g=d+d;const h=e+e;c*=f;const l=d*f;d*=g;const k=e*f,m=e*g;e*=h;f*=a;g*=a;a*=h;b[0]=1-d-e;b[1]=l+a;b[2]=k-g;b[3]=0;b[4]=l-a;b[5]=1-c-e;b[6]=m+f;b[7]=0;b[8]=k+g;b[9]=m-f;b[10]=1-c-d;b[11]=0;return b},getAxis:function(a,b,c){c=c||ba();b*=4;c[0]=a[b+0];c[1]=a[b+1];return c},getScaling:function(a,
b){b=b||ba();const c=a[0],d=a[1],e=a[4];a=a[5];b[0]=Math.sqrt(c*c+d*d);b[1]=Math.sqrt(e*e+a*a);return b},getTranslation:function(a,b){b=b||ba();b[0]=a[8];b[1]=a[9];return b},identity:Ja,inverse:Ka,invert:Ka,mul:La,multiply:La,negate:function(a,b){b=b||H();b[0]=-a[0];b[1]=-a[1];b[2]=-a[2];b[4]=-a[4];b[5]=-a[5];b[6]=-a[6];b[8]=-a[8];b[9]=-a[9];b[10]=-a[10];return b},rotate:function(a,b,c){c=c||H();const d=a[0],e=a[1],f=a[2],g=a[4],h=a[5],l=a[6],k=Math.cos(b);b=Math.sin(b);c[0]=k*d+b*g;c[1]=k*e+b*h;
c[2]=k*f+b*l;c[4]=k*g-b*d;c[5]=k*h-b*e;c[6]=k*l-b*f;a!==c&&(c[8]=a[8],c[9]=a[9],c[10]=a[10]);return c},rotation:function(a,b){b=b||H();const c=Math.cos(a);a=Math.sin(a);b[0]=c;b[1]=a;b[2]=0;b[4]=-a;b[5]=c;b[6]=0;b[8]=0;b[9]=0;b[10]=1;return b},scale:function(a,b,c){c=c||H();const d=b[0];b=b[1];c[0]=d*a[0];c[1]=d*a[1];c[2]=d*a[2];c[4]=b*a[4];c[5]=b*a[5];c[6]=b*a[6];a!==c&&(c[8]=a[8],c[9]=a[9],c[10]=a[10]);return c},scaling:function(a,b){b=b||H();b[0]=a[0];b[1]=0;b[2]=0;b[4]=0;b[5]=a[1];b[6]=0;b[8]=
0;b[9]=0;b[10]=1;return b},set:function(a,b,c,d,e,f,g,h,l,k){k=k||H();k[0]=a;k[1]=b;k[2]=c;k[3]=0;k[4]=d;k[5]=e;k[6]=f;k[7]=0;k[8]=g;k[9]=h;k[10]=l;k[11]=0;return k},setAxis:function(a,b,c,d){d!==a&&(d=pa(a,d));a=4*c;d[a+0]=b[0];d[a+1]=b[1];return d},setDefaultType:Ga,setTranslation:function(a,b,c){c=c||Ja();a!==c&&(c[0]=a[0],c[1]=a[1],c[2]=a[2],c[4]=a[4],c[5]=a[5],c[6]=a[6]);c[8]=b[0];c[9]=b[1];c[10]=1;return c},translate:function(a,b,c){c=c||H();const d=b[0];b=b[1];const e=a[0],f=a[1],g=a[2],h=
a[4],l=a[5],k=a[6],m=a[8],n=a[9],q=a[10];a!==c&&(c[0]=e,c[1]=f,c[2]=g,c[4]=h,c[5]=l,c[6]=k);c[8]=e*d+h*b+m;c[9]=f*d+l*b+n;c[10]=g*d+k*b+q;return c},translation:function(a,b){b=b||H();b[0]=1;b[1]=0;b[2]=0;b[4]=0;b[5]=1;b[6]=0;b[8]=a[0];b[9]=a[1];b[10]=1;return b},transpose:function(a,b){b=b||H();if(b===a){var c=a[1];a[1]=a[4];a[4]=c;c=a[2];a[2]=a[8];a[8]=c;c=a[6];a[6]=a[9];a[9]=c;return b}c=a[1];const d=a[2],e=a[4],f=a[5],g=a[6],h=a[8],l=a[9],k=a[10];b[0]=a[0];b[1]=e;b[2]=h;b[4]=c;b[5]=f;b[6]=l;b[8]=
d;b[9]=g;b[10]=k;return b}});let w=Float32Array;var Db=Object.freeze({__proto__:null,add:function(a,b,c){c=c||new w(3);c[0]=a[0]+b[0];c[1]=a[1]+b[1];c[2]=a[2]+b[2];return c},addScaled:function(a,b,c,d){d=d||new w(3);d[0]=a[0]+b[0]*c;d[1]=a[1]+b[1]*c;d[2]=a[2]+b[2]*c;return d},angle:function(a,b){var c=a[0];const d=a[1],e=a[2],f=a[0],g=a[1],h=a[2];a=(c=Math.sqrt(c*c+d*d+e*e)*Math.sqrt(f*f+g*g+h*h))&&qa(a,b)/c;return Math.acos(a)},ceil:function(a,b){b=b||new w(3);b[0]=Math.ceil(a[0]);b[1]=Math.ceil(a[1]);
b[2]=Math.ceil(a[2]);return b},clamp:function(a,b=0,c=1,d){d=d||new w(3);d[0]=Math.min(c,Math.max(b,a[0]));d[1]=Math.min(c,Math.max(b,a[1]));d[2]=Math.min(c,Math.max(b,a[2]));return d},clone:Sa,copy:Sa,create:G,cross:P,dist:Qa,distSq:Ra,distance:Qa,distanceSq:Ra,div:Ua,divScalar:function(a,b,c){c=c||new w(3);c[0]=a[0]/b;c[1]=a[1]/b;c[2]=a[2]/b;return c},divide:Ua,dot:qa,equals:function(a,b){return a[0]===b[0]&&a[1]===b[1]&&a[2]===b[2]},equalsApproximately:function(a,b){return Math.abs(a[0]-b[0])<
r&&Math.abs(a[1]-b[1])<r&&Math.abs(a[2]-b[2])<r},floor:function(a,b){b=b||new w(3);b[0]=Math.floor(a[0]);b[1]=Math.floor(a[1]);b[2]=Math.floor(a[2]);return b},fromValues:G,getAxis:function(a,b,c){c=c||new w(3);b*=4;c[0]=a[b+0];c[1]=a[b+1];c[2]=a[b+2];return c},getScaling:function(a,b){b=b||new w(3);const c=a[0],d=a[1],e=a[2],f=a[4],g=a[5],h=a[6],l=a[8],k=a[9];a=a[10];b[0]=Math.sqrt(c*c+d*d+e*e);b[1]=Math.sqrt(f*f+g*g+h*h);b[2]=Math.sqrt(l*l+k*k+a*a);return b},getTranslation:function(a,b){b=b||new w(3);
b[0]=a[12];b[1]=a[13];b[2]=a[14];return b},inverse:Oa,invert:Oa,len:ra,lenSq:Pa,length:ra,lengthSq:Pa,lerp:function(a,b,c,d){d=d||new w(3);d[0]=a[0]+c*(b[0]-a[0]);d[1]=a[1]+c*(b[1]-a[1]);d[2]=a[2]+c*(b[2]-a[2]);return d},lerpV:function(a,b,c,d){d=d||new w(3);d[0]=a[0]+c[0]*(b[0]-a[0]);d[1]=a[1]+c[1]*(b[1]-a[1]);d[2]=a[2]+c[2]*(b[2]-a[2]);return d},max:function(a,b,c){c=c||new w(3);c[0]=Math.max(a[0],b[0]);c[1]=Math.max(a[1],b[1]);c[2]=Math.max(a[2],b[2]);return c},min:function(a,b,c){c=c||new w(3);
c[0]=Math.min(a[0],b[0]);c[1]=Math.min(a[1],b[1]);c[2]=Math.min(a[2],b[2]);return c},mul:Ta,mulScalar:Na,multiply:Ta,negate:function(a,b){b=b||new w(3);b[0]=-a[0];b[1]=-a[1];b[2]=-a[2];return b},normalize:O,random:function(a=1,b){b=b||new w(3);const c=2*Math.random()*Math.PI,d=2*Math.random()-1,e=Math.sqrt(1-d*d)*a;b[0]=Math.cos(c)*e;b[1]=Math.sin(c)*e;b[2]=d*a;return b},round:function(a,b){b=b||new w(3);b[0]=Math.round(a[0]);b[1]=Math.round(a[1]);b[2]=Math.round(a[2]);return b},scale:Na,set:function(a,
b,c,d){d=d||new w(3);d[0]=a;d[1]=b;d[2]=c;return d},setDefaultType:Ma,sub:ca,subtract:ca,transformMat3:function(a,b,c){c=c||new w(3);const d=a[0],e=a[1];a=a[2];c[0]=d*b[0]+e*b[4]+a*b[8];c[1]=d*b[1]+e*b[5]+a*b[9];c[2]=d*b[2]+e*b[6]+a*b[10];return c},transformMat4:function(a,b,c){c=c||new w(3);const d=a[0],e=a[1];a=a[2];const f=b[3]*d+b[7]*e+b[11]*a+b[15]||1;c[0]=(b[0]*d+b[4]*e+b[8]*a+b[12])/f;c[1]=(b[1]*d+b[5]*e+b[9]*a+b[13])/f;c[2]=(b[2]*d+b[6]*e+b[10]*a+b[14])/f;return c},transformMat4Upper3x3:function(a,
b,c){c=c||new w(3);const d=a[0],e=a[1];a=a[2];c[0]=d*b[0]+e*b[4]+a*b[8];c[1]=d*b[1]+e*b[5]+a*b[9];c[2]=d*b[2]+e*b[6]+a*b[10];return c},transformQuat:function(a,b,c){c=c||new w(3);const d=b[0],e=b[1],f=b[2];b=2*b[3];const g=a[0],h=a[1];a=a[2];const l=e*a-f*h,k=f*g-d*a,m=d*h-e*g;c[0]=g+l*b+2*(e*m-f*k);c[1]=h+k*b+2*(f*l-d*m);c[2]=a+m*b+2*(d*k-e*l);return c},zero:function(a){a=a||new w(3);a[0]=0;a[1]=0;a[2]=0;return a}});let x=Float32Array,A,D,y;var Eb=Object.freeze({__proto__:null,aim:function(a,b,c,
d){d=d||new x(16);A=A||G();D=D||G();y=y||G();O(ca(b,a,y),y);O(P(c,y,A),A);O(P(y,A,D),D);d[0]=A[0];d[1]=A[1];d[2]=A[2];d[3]=0;d[4]=D[0];d[5]=D[1];d[6]=D[2];d[7]=0;d[8]=y[0];d[9]=y[1];d[10]=y[2];d[11]=0;d[12]=a[0];d[13]=a[1];d[14]=a[2];d[15]=1;return d},axisRotate:bb,axisRotation:ab,cameraAim:function(a,b,c,d){d=d||new x(16);A=A||G();D=D||G();y=y||G();O(ca(a,b,y),y);O(P(c,y,A),A);O(P(y,A,D),D);d[0]=A[0];d[1]=A[1];d[2]=A[2];d[3]=0;d[4]=D[0];d[5]=D[1];d[6]=D[2];d[7]=0;d[8]=y[0];d[9]=y[1];d[10]=y[2];d[11]=
0;d[12]=a[0];d[13]=a[1];d[14]=a[2];d[15]=1;return d},clone:sa,copy:sa,create:function(a,b,c,d,e,f,g,h,l,k,m,n,q,v,u,t){const p=new x(16);void 0!==a&&(p[0]=a,void 0!==b&&(p[1]=b,void 0!==c&&(p[2]=c,void 0!==d&&(p[3]=d,void 0!==e&&(p[4]=e,void 0!==f&&(p[5]=f,void 0!==g&&(p[6]=g,void 0!==h&&(p[7]=h,void 0!==l&&(p[8]=l,void 0!==k&&(p[9]=k,void 0!==m&&(p[10]=m,void 0!==n&&(p[11]=n,void 0!==q&&(p[12]=q,void 0!==v&&(p[13]=v,void 0!==u&&(p[14]=u,void 0!==t&&(p[15]=t))))))))))))))));return p},determinant:function(a){const b=
a[1];var c=a[2],d=a[3];const e=a[5],f=a[6],g=a[7],h=a[9];var l=a[10],k=a[11];const m=a[13];var n=a[14],q=a[15];const v=l*q,u=n*k,t=f*q,p=n*g,E=f*k,F=l*g;q*=c;n*=d;k*=c;l*=d;c*=g;d*=f;return a[0]*(v*e+p*h+E*m-(u*e+t*h+F*m))+a[4]*(u*b+q*h+l*m-(v*b+n*h+k*m))+a[8]*(t*b+n*e+c*m-(p*b+q*e+d*m))+a[12]*(F*b+k*e+d*h-(E*b+l*e+c*h))},equals:function(a,b){return a[0]===b[0]&&a[1]===b[1]&&a[2]===b[2]&&a[3]===b[3]&&a[4]===b[4]&&a[5]===b[5]&&a[6]===b[6]&&a[7]===b[7]&&a[8]===b[8]&&a[9]===b[9]&&a[10]===b[10]&&a[11]===
b[11]&&a[12]===b[12]&&a[13]===b[13]&&a[14]===b[14]&&a[15]===b[15]},equalsApproximately:function(a,b){return Math.abs(a[0]-b[0])<r&&Math.abs(a[1]-b[1])<r&&Math.abs(a[2]-b[2])<r&&Math.abs(a[3]-b[3])<r&&Math.abs(a[4]-b[4])<r&&Math.abs(a[5]-b[5])<r&&Math.abs(a[6]-b[6])<r&&Math.abs(a[7]-b[7])<r&&Math.abs(a[8]-b[8])<r&&Math.abs(a[9]-b[9])<r&&Math.abs(a[10]-b[10])<r&&Math.abs(a[11]-b[11])<r&&Math.abs(a[12]-b[12])<r&&Math.abs(a[13]-b[13])<r&&Math.abs(a[14]-b[14])<r&&Math.abs(a[15]-b[15])<r},fromMat3:function(a,
...
c[10]=b*a[10];c[11]=b*a[11];a!==c&&(c[12]=a[12],c[13]=a[13],c[14]=a[14],c[15]=a[15]);return c},scaling:function(a,b){b=b||new x(16);b[0]=a[0];b[1]=0;b[2]=0;b[3]=0;b[4]=0;b[5]=a[1];b[6]=0;b[7]=0;b[8]=0;b[9]=0;b[10]=a[2];b[11]=0;b[12]=0;b[13]=0;b[14]=0;b[15]=1;return b},set:function(a,b,c,d,e,f,g,h,l,k,m,n,q,v,u,t,p){p=p||new x(16);p[0]=a;p[1]=b;p[2]=c;p[3]=d;p[4]=e;p[5]=f;p[6]=g;p[7]=h;p[8]=l;p[9]=k;p[10]=m;p[11]=n;p[12]=q;p[13]=v;p[14]=u;p[15]=t;return p},setAxis:function(a,b,c,d){d!==a&&(d=sa(a,
d));a=4*c;d[a+0]=b[0];d[a+1]=b[1];d[a+2]=b[2];return d},setDefaultType:Va,setTranslation:function(a,b,c){c=c||Wa();a!==c&&(c[0]=a[0],c[1]=a[1],c[2]=a[2],c[3]=a[3],c[4]=a[4],c[5]=a[5],c[6]=a[6],c[7]=a[7],c[8]=a[8],c[9]=a[9],c[10]=a[10],c[11]=a[11]);c[12]=b[0];c[13]=b[1];c[14]=b[2];c[15]=1;return c},translate:function(a,b,c){c=c||new x(16);const d=b[0],e=b[1];b=b[2];const f=a[0],g=a[1],h=a[2],l=a[3],k=a[4],m=a[5],n=a[6],q=a[7],v=a[8],u=a[9],t=a[10],p=a[11],E=a[12],F=a[13],I=a[14],J=a[15];a!==c&&(c[0]=
f,c[1]=g,c[2]=h,c[3]=l,c[4]=k,c[5]=m,c[6]=n,c[7]=q,c[8]=v,c[9]=u,c[10]=t,c[11]=p);c[12]=f*d+k*e+v*b+E;c[13]=g*d+m*e+u*b+F;c[14]=h*d+n*e+t*b+I;c[15]=l*d+q*e+p*b+J;return c},translation:function(a,b){b=b||new x(16);b[0]=1;b[1]=0;b[2]=0;b[3]=0;b[4]=0;b[5]=1;b[6]=0;b[7]=0;b[8]=0;b[9]=0;b[10]=1;b[11]=0;b[12]=a[0];b[13]=a[1];b[14]=a[2];b[15]=1;return b},transpose:function(a,b){b=b||new x(16);if(b===a){var c=a[1];a[1]=a[4];a[4]=c;c=a[2];a[2]=a[8];a[8]=c;c=a[3];a[3]=a[12];a[12]=c;c=a[6];a[6]=a[9];a[9]=c;
c=a[7];a[7]=a[13];a[13]=c;c=a[11];a[11]=a[14];a[14]=c;return b}c=a[1];const d=a[2],e=a[3],f=a[4],g=a[5],h=a[6],l=a[7],k=a[8],m=a[9],n=a[10],q=a[11],v=a[12],u=a[13],t=a[14],p=a[15];b[0]=a[0];b[1]=f;b[2]=k;b[3]=v;b[4]=c;b[5]=g;b[6]=m;b[7]=u;b[8]=d;b[9]=h;b[10]=n;b[11]=t;b[12]=e;b[13]=l;b[14]=q;b[15]=p;return b}});let B=Float32Array,N,ta,ua,na,oa;var Fb=Object.freeze({__proto__:null,add:function(a,b,c){c=c||new B(4);c[0]=a[0]+b[0];c[1]=a[1]+b[1];c[2]=a[2]+b[2];c[3]=a[3]+b[3];return c},angle:function(a,
b){a=jb(a,b);return Math.acos(2*a*a-1)},clone:gb,conjugate:function(a,b){b=b||new B(4);b[0]=-a[0];b[1]=-a[1];b[2]=-a[2];b[3]=a[3];return b},copy:gb,create:db,divScalar:function(a,b,c){c=c||new B(4);c[0]=a[0]/b;c[1]=a[1]/b;c[2]=a[2]/b;c[3]=a[3]/b;return c},dot:jb,equals:function(a,b){return a[0]===b[0]&&a[1]===b[1]&&a[2]===b[2]&&a[3]===b[3]},equalsApproximately:function(a,b){return Math.abs(a[0]-b[0])<r&&Math.abs(a[1]-b[1])<r&&Math.abs(a[2]-b[2])<r&&Math.abs(a[3]-b[3])<r},fromAxisAngle:eb,fromEuler:function(a,
...
new C(4);c[0]=a[0]/b;c[1]=a[1]/b;c[2]=a[2]/b;c[3]=a[3]/b;return c},divide:yb,dot:function(a,b){return a[0]*b[0]+a[1]*b[1]+a[2]*b[2]+a[3]*b[3]},equals:function(a,b){return a[0]===b[0]&&a[1]===b[1]&&a[2]===b[2]&&a[3]===b[3]},equalsApproximately:function(a,b){return Math.abs(a[0]-b[0])<r&&Math.abs(a[1]-b[1])<r&&Math.abs(a[2]-b[2])<r&&Math.abs(a[3]-b[3])<r},floor:function(a,b){b=b||new C(4);b[0]=Math.floor(a[0]);b[1]=Math.floor(a[1]);b[2]=Math.floor(a[2]);b[3]=Math.floor(a[3]);return b},fromValues:ob,
