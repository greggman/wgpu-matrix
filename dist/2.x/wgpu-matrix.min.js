...
new x(16);a[0]=1;a[1]=0;a[2]=0;a[3]=0;a[4]=0;a[5]=1;a[6]=0;a[7]=0;a[8]=0;a[9]=0;a[10]=1;a[11]=0;a[12]=0;a[13]=0;a[14]=0;a[15]=1;return a}function Xa(a,b){b=b||new x(16);const c=a[0];var d=a[1];const e=a[2],f=a[3],g=a[4];var h=a[5];const l=a[6],k=a[7],m=a[8],n=a[9],q=a[10],v=a[11],u=a[12];var t=a[13];const p=a[14];a=a[15];const E=q*a,F=p*v,I=l*a,J=p*k,K=l*v,L=q*k,Q=e*a,R=p*f,S=e*v,T=q*f,U=e*k,V=l*f,W=m*t,X=u*n,Y=g*t,Z=u*h,da=g*n,ea=m*h,fa=c*t,ha=u*d,ia=c*n,ja=m*d,ka=c*h,la=g*d,Ya=E*h+J*n+K*t-(F*h+
I*n+L*t),Za=F*d+Q*n+T*t-(E*d+R*n+S*t);t=I*d+R*h+U*t-(J*d+Q*h+V*t);d=L*d+S*h+V*n-(K*d+T*h+U*n);h=1/(c*Ya+g*Za+m*t+u*d);b[0]=h*Ya;b[1]=h*Za;b[2]=h*t;b[3]=h*d;b[4]=h*(F*g+I*m+L*u-(E*g+J*m+K*u));b[5]=h*(E*c+R*m+S*u-(F*c+Q*m+T*u));b[6]=h*(J*c+Q*g+V*u-(I*c+R*g+U*u));b[7]=h*(K*c+T*g+U*m-(L*c+S*g+V*m));b[8]=h*(W*k+Z*v+da*a-(X*k+Y*v+ea*a));b[9]=h*(X*f+fa*v+ja*a-(W*f+ha*v+ia*a));b[10]=h*(Y*f+ha*k+ka*a-(Z*f+fa*k+la*a));b[11]=h*(ea*f+ia*k+la*v-(da*f+ja*k+ka*v));b[12]=h*(Y*q+ea*p+X*l-(da*p+W*l+Z*q));b[13]=h*(ia*
p+W*e+ha*q-(fa*q+ja*p+X*e));b[14]=h*(fa*l+la*p+Z*e-(ka*p+Y*e+ha*l));b[15]=h*(ka*q+da*e+ja*l-(ia*l+la*q+ea*e));return b}function $a(a,b,c){c=c||new x(16);const d=a[0],e=a[1],f=a[2],g=a[3],h=a[4],l=a[5],k=a[6],m=a[7],n=a[8],q=a[9],v=a[10],u=a[11],t=a[12],p=a[13],E=a[14];a=a[15];const F=b[0],I=b[1],J=b[2],K=b[3],L=b[4],Q=b[5],R=b[6],S=b[7],T=b[8],U=b[9],V=b[10],W=b[11],X=b[12],Y=b[13],Z=b[14];b=b[15];c[0]=d*F+h*I+n*J+t*K;c[1]=e*F+l*I+q*J+p*K;c[2]=f*F+k*I+v*J+E*K;c[3]=g*F+m*I+u*J+a*K;c[4]=d*L+h*Q+n*R+
t*S;c[5]=e*L+l*Q+q*R+p*S;c[6]=f*L+k*Q+v*R+E*S;c[7]=g*L+m*Q+u*R+a*S;c[8]=d*T+h*U+n*V+t*W;c[9]=e*T+l*U+q*V+p*W;c[10]=f*T+k*U+v*V+E*W;c[11]=g*T+m*U+u*V+a*W;c[12]=d*X+h*Y+n*Z+t*b;c[13]=e*X+l*Y+q*Z+p*b;c[14]=f*X+k*Y+v*Z+E*b;c[15]=g*X+m*Y+u*Z+a*b;return c}function ab(a,b,c){c=c||new x(16);let d=a[0],e=a[1];a=a[2];var f=Math.sqrt(d*d+e*e+a*a);d/=f;e/=f;a/=f;f=d*d;const g=e*e,h=a*a,l=Math.cos(b);b=Math.sin(b);const k=1-l;c[0]=f+(1-f)*l;c[1]=d*e*k+a*b;c[2]=d*a*k-e*b;c[3]=0;c[4]=d*e*k-a*b;c[5]=g+(1-g)*l;c[6]=
e*a*k+d*b;c[7]=0;c[8]=d*a*k+e*b;c[9]=e*a*k-d*b;c[10]=h+(1-h)*l;c[11]=0;c[12]=0;c[13]=0;c[14]=0;c[15]=1;return c}function bb(a,b,c,d){d=d||new x(16);var e=b[0],f=b[1],g=b[2];b=Math.sqrt(e*e+f*f+g*g);e/=b;f/=b;g/=b;b=e*e;var h=f*f,l=g*g,k=Math.cos(c),m=Math.sin(c),n=1-k;c=b+(1-b)*k;b=e*f*n+g*m;const q=e*g*n-f*m,v=e*f*n-g*m;h+=(1-h)*k;const u=f*g*n+e*m,t=e*g*n+f*m;e=f*g*n-e*m;f=l+(1-l)*k;g=a[0];l=a[1];k=a[2];m=a[3];n=a[4];const p=a[5],E=a[6],F=a[7],I=a[8],J=a[9],K=a[10],L=a[11];d[0]=c*g+b*n+q*I;d[1]=
c*l+b*p+q*J;d[2]=c*k+b*E+q*K;d[3]=c*m+b*F+q*L;d[4]=v*g+h*n+u*I;d[5]=v*l+h*p+u*J;d[6]=v*k+h*E+u*K;d[7]=v*m+h*F+u*L;d[8]=t*g+e*n+f*I;d[9]=t*l+e*p+f*J;d[10]=t*k+e*E+f*K;d[11]=t*m+e*F+f*L;a!==d&&(d[12]=a[12],d[13]=a[13],d[14]=a[14],d[15]=a[15]);return d}function cb(a){const b=B;B=a;return b}function db(a,b,c,d){const e=new B(4);void 0!==a&&(e[0]=a,void 0!==b&&(e[1]=b,void 0!==c&&(e[2]=c,void 0!==d&&(e[3]=d))));return e}function eb(a,b,c){c=c||new B(4);b*=.5;const d=Math.sin(b);c[0]=d*a[0];c[1]=d*a[1];
...
c=a[7];a[7]=a[13];a[13]=c;c=a[11];a[11]=a[14];a[14]=c;return b}c=a[1];const d=a[2],e=a[3],f=a[4],g=a[5],h=a[6],l=a[7],k=a[8],m=a[9],n=a[10],q=a[11],v=a[12],u=a[13],t=a[14],p=a[15];b[0]=a[0];b[1]=f;b[2]=k;b[3]=v;b[4]=c;b[5]=g;b[6]=m;b[7]=u;b[8]=d;b[9]=h;b[10]=n;b[11]=t;b[12]=e;b[13]=l;b[14]=q;b[15]=p;return b}});let B=Float32Array,N,ta,ua,na,oa;var Eb=Object.freeze({__proto__:null,add:function(a,b,c){c=c||new B(4);c[0]=a[0]+b[0];c[1]=a[1]+b[1];c[2]=a[2]+b[2];c[3]=a[3]+b[3];return c},angle:function(a,
